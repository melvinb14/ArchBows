...
public class LongbowItem extends BowItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        if (isShiftPressed) {
            ...
            tooltip.add((new TranslatableComponent(String.format("tooltip.archbows.heavy_crossbow.desc_5", "archbows")).withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.ITALIC));
            tooltip.add((new TranslatableComponent(String.format("tooltip.archbows.longbow.desc", "archbows")) .withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.ITALIC));
