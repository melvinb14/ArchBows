...
public class ShortbowItem extends BowItem {
    ...
    public ShortbowItem(Properties prop, Tiers material, float drawSpeed) {
        super(prop);
        this.drawSpeed = drawSpeed;
        this.modId = null;
        this.material = material;
        this.maxVelocity = 0.55F;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        if (isShiftPressed) {
            ...
            tooltip.add((Component.translatable(String.format("tooltip.archbows.shortbow.desc", "archbows")).withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.ITALIC));
            tooltip.add((Component.translatable(String.format("tooltip.archbows.shortbow.desc_1", "archbows")).withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.ITALIC));
