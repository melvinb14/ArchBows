...
public class ShortbowItem extends BowItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        if (isShiftPressed) {
            ...
            tooltip.add((new TranslatableComponent(String.format("tooltip.archbows.shortbow.desc", "archbows")).withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.ITALIC));
            tooltip.add((new TranslatableComponent(String.format("tooltip.archbows.shortbow.desc_1", "archbows")).withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.ITALIC));
