...
public class FlatbowItem extends BowItem {
    ...
    public FlatbowItem(Properties prop, Tiers material) {
        ...
        if (FMLEnvironment.dist.isClient()) {
            BowProperties.registerFlatBowProperties(this);
        }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        if (isShiftPressed) {
            ...
            tooltip.add((Component.translatable(String.format("tooltip.archbows.heavy_crossbow.desc", "archbows")).withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.ITALIC));
