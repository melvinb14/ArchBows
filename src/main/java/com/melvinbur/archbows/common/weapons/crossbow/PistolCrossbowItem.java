...
public class  PistolCrossbowItem extends CrossbowItem {
    ...
    public PistolCrossbowItem(Item.Properties pProperties,float maxVelocity, int loadTime, Tiers material) {
        super(pProperties);
        ...
        if (FMLEnvironment.dist.isClient()) {
            CrossbowProperties.registerPistolCrossbowProperties(this);
        }
