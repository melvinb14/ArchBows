...
public class ItemInit {
    ...
    public static final RegistryObject<Item> ARBALEST = ITEMS.register("arbalest",
            () -> new ArbalestItem(new Item.Properties().tab(CreativeModeTabInit.ARCHBOWS_TAB).stacksTo(1).durability(ABConfig.CONFIG.arbalestDurability.get()),ABConfig.CONFIG.ArbalestProjectileVelocity.get().floatValue(),ABConfig.CONFIG.arbalestLoadTime.get(), WOOD));

    public static final RegistryObject<Item> HEAVY_CROSSBOW = ITEMS.register("heavy_crossbow",
            () -> new HeavyCrossbowItem(new Item.Properties().tab(CreativeModeTabInit.ARCHBOWS_TAB).stacksTo(1).durability(ABConfig.CONFIG.heavyCrossbowDurability.get()), ABConfig.CONFIG.HeavyCrossbowProjectileVelocity.get().floatValue(),ABConfig.CONFIG.heavycrossbowLoadTime.get(), WOOD));


    public static final RegistryObject<Item> PISTOL_CROSSBOW = ITEMS.register("pistol_crossbow",
            () -> new PistolCrossbowItem(new Item.Properties().tab(CreativeModeTabInit.ARCHBOWS_TAB).stacksTo(1).durability(ABConfig.CONFIG.pistolCrossbowDurability.get()),ABConfig.CONFIG.PistolCrossbowProjectileVelocity.get().floatValue(),ABConfig.CONFIG.pistolcrossbowLoadTime.get(), WOOD));
