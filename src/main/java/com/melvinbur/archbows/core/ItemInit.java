...
public class ItemInit {
    ...
    public static final RegistryObject<BaseBowItem> RECURVE_BOW = ITEMS.register("recurve",
            () -> new BaseBowItem(new Item.Properties().stacksTo(1).durability(ABConfig.CONFIG.recurveBowDurability.get()),ABConfig.CONFIG.recurvebowDrawspeed.get().floatValue(),  ABConfig.CONFIG.RecurveBowProjectileVelocity.get().floatValue(), WOOD));
    ...
    public static final RegistryObject<ArbalestItem> ARBALEST = ITEMS.register("arbalest",
            () -> new ArbalestItem(new Item.Properties().stacksTo(1).durability(ABConfig.CONFIG.arbalestDurability.get()),ABConfig.CONFIG.ArbalestProjectileVelocity.get().floatValue(),ABConfig.CONFIG.arbalestLoadTime.get(),ABConfig.CONFIG.arbalestAimTime.get(), IRON));

    public static final RegistryObject<HeavyCrossbowItem> HEAVY_CROSSBOW = ITEMS.register("heavy_crossbow",
            () -> new HeavyCrossbowItem(new Item.Properties().stacksTo(1).durability(ABConfig.CONFIG.heavyCrossbowDurability.get()), ABConfig.CONFIG.HeavyCrossbowProjectileVelocity.get().floatValue(),ABConfig.CONFIG.heavycrossbowLoadTime.get(),ABConfig.CONFIG.heavycrossbowAimTime.get(), WOOD));


    public static final RegistryObject<PistolCrossbowItem> PISTOL_CROSSBOW = ITEMS.register("pistol_crossbow",
            () -> new PistolCrossbowItem(new Item.Properties().stacksTo(1).durability(ABConfig.CONFIG.pistolCrossbowDurability.get()),ABConfig.CONFIG.PistolCrossbowProjectileVelocity.get().floatValue(),ABConfig.CONFIG.pistolcrossbowLoadTime.get(),ABConfig.CONFIG.pistolcrossbowAimTime.get(), IRON));
