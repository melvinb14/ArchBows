package com.melvinbur.archbows.world.features.stateproviders;

import com.melvinbur.archbows.world.ABFeatures;
...
public class DirectionalStateProvider extends BlockStateProvider {
    ...
    protected BlockStateProviderType<?> type() {
        return ABFeatures.StateProviders.DIRECTIONAL_STATE_PROVIDER.get();
    }
